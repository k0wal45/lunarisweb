    ...
    >
      <div className="flex flex-col gap-2 items-center justify-center text-center">
        ...
        <p className="lg:w-2/3 text-lg">
          Świadcze usługi tworzenia responsywnych i szybkich stron
          internetowycyh, logotypów i wszelkiego rodzaju materiałów reklamowych
          takich jak wizytówki czy banery reklamowe
        </p>
      </div>
      ...
      <div className="text-neutral-600">
        Działam też lokalnie:{" "}
        <TransitionLink
          href="/uslugi/strony-internetowe-katowice"
          className="underline hover:text-neutral-400 active:text-neutral-800 transition-colors duration-150"
        >
          Strony internetowe Katowice
        </TransitionLink>{" "}
        i{" "}
        <TransitionLink
          href="/uslugi/strony-internetowe-slask"
          className="underline hover:text-neutral-400 active:text-neutral-800 transition-colors duration-150"
        >
