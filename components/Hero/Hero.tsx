...
async function Hero() {
  ...
  return (
    <header className={`${classes.bgGrid} mb-12 min-h-screen lg:min-h-[96vh] w-full relative flex flex-col lg:flex-row items-center justify-around gap-8 p-4 text-center border-[1px] border-[#5a5a5a] rounded-xl`}>
      <Navbar />
    ...
    <div className="flex flex-col justify-between items-center z-10 text-white gap-4 py-8">
      <h1 className="mt-12 lg:mt-0
      text-5xl md:text-[6rem] font-bold relative z-20
      bg-clip-text text-transparent
      bg-gradient-to-b from-neutral-200 to-primary 
      py-8 flex flex-col items-center text-center w-screen min-h-[23rem]">
        Tworzymy
        <TyperWriter /> 
      </h1>
