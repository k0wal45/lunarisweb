...
const ContactSec = () => {
  ...
  return (
    <section ref={ref} className={`relative bg-[#ededed] lg:bg-contain flex flex-col mx-auto gap-4 p-4 py-12 w-ful items-center justify-center shadow-inner w-full`}>
