    ...
    <UnderlineOnHover>
      ...
      >
        <Image
          ...
          width={800}
          height={800}
          className="absolute top-0 left-0 w-full h-full z-10 brightness-50 object-cover object-top origin-top-left group-hover:scale-125 transition-transform ease-in-out duration-700"
        />
