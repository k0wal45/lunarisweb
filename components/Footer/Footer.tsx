...
function Footer() {
  ...
  return (
    <footer
      className={`rounded-t-3xl grid grid-cols-1 lg:grid-cols-3 lg:h-56 items-center justify-center gap-12 px-4 pt-6 overflow-hidden relative`}
    >
      ...
      <p className="font-bold text-3xl h-full grid place-items-center">
        ©{year} Lunaris Web
      </p>

      <div
        onClick={() => window.scrollTo(0, 0)}
        className="flex flex-col gap-2 justify-center items-center cursor-pointer translate-y-[-10px]"
      >
        <Image
          src="/img/logo.png"
