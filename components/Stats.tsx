...
function Stats() {
  ...
  return (
    <section className="m-auto flex flex-col lg:flex-row p-4 w-full border-b-2 border-base overflow-hidden">
        <div className="flex-1 p-4 flex flex-col gap-4 text-center lg:text-start">
        ...
        <div className=" w-48 lg:w-0 lg:h-32 border-[1px] border-base m-auto"></div> 

        <div className="flex-1 h-32 p-4 flex flex-col gap-4 text-center lg:text-start">
