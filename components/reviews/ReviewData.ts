const data = [
  {
    ...
    rate: '5',
    link: 'https://g.co/kgs/PAQwA3h'
  },
  {
    img: '/img/googleReviews/2.png',
    name: 'Magdalena Krawczyk',
    opinion: 'Polecam firmę. Profesjonalne podejście do zlecenia, błyskawiczną reakcja na życzenie klienta. Rozsądne ceny usług. Na pewno zrealizujemy jeszcze nie jedno zlecenie.',
    rate: '5',
    link: 'https://g.co/kgs/55AVSkF'
  },
  {
    img: '/img/googleReviews/3.png',
    ...
    rate: '5',
    link: 'https://g.co/kgs/a9fnkvy'
  },
  {
    img: '/img/googleReviews/4.png',
    name: 'Wiktor Rubinski',
    ...
    rate: '5',
    link: 'https://g.co/kgs/bUut1HR'
  },
  {
    img: '/img/googleReviews/5.png',
    ...
    rate: '5',
    link: 'https://g.co/kgs/vMNLa9X'
  },
  {
    img: '/img/googleReviews/6.png',
    name: 'Magdalena Tylki',
    opinion: 'Rzetelna i uczciwa Firma. Kompetencja i kreatywność to czołowe atuty Firmy. Polecam 😊',
    rate: '5',
    link: 'https://g.co/kgs/gYKPaf3'
  },
